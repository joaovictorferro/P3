		...
		do {
			...
			if (i == 1) {
				...
				for (k = 0; k < 50; k++) {
					...
					if (semanaQ % 2 == 0 && diadaSemana.equals(empregado[k][8]) && empregado[k][4].equals("Sim")) {
						...
						System.out.println("Salário do empregado " + empregado[k][0] + ": R$" + salarioP + "\n");
					}
					
					if ("Assalariado".equals(empregado[k][2]) && "Nao".equals(empregado[k][4])) {
					...
					if ("Horista".equals(empregado[k][2])) {
