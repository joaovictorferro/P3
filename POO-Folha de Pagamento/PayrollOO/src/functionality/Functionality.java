...
import employee.WageEarner;
import utilitarios.Exceptions;
import utilitarios.UndoRedo;
...
public class Functionality {
    ...
    public List<Employee> copy = new ArrayList<Employee>();
	...
	public Functionality() {
	 ...
	 public void addEmployee(){
	    ...
	    public void undo(){
	        ...
	        employee = (ArrayList<Employee>) undoRedo.undoStack.pop();
	        cont = undoRedo.counterUndo.pop();
	    }

	    public void redo(){
	        if(undoRedo.redoStack.empty()  || undoRedo.counterRedo.empty()){
	            return;
	        }
	        copyRegister();
	        employee = (ArrayList<Employee>) undoRedo.redoStack.pop();
